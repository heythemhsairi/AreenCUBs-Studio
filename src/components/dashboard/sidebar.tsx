...
const ICONS: Record<string, string> = {
  ...
  planning: "M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z M16 3v4 M8 3v4 M3 11h18 M8 15h2 M14 15h2 M8 19h2",
...
export function Sidebar({ role }: { role: UserRole }) {
  ...
  return (
    <aside className="hidden w-60 shrink-0 md:block">
      <div className="glass sticky top-[80px] m-4 mt-6 rounded-2xl p-3">
        <p className="px-3 pb-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-ink/40">
          Navigation
        </p>
