    ...
    >
      {COLUMN_ORDER.map((status) => {
        ...
        return (
          ...
          >
            <div className="flex items-center justify-between rounded-lg bg-surface/70 px-3 py-2 ring-1 ring-ink/5">
              <div className="flex items-center gap-2">
                ...
                />
                <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-content-3">
                  {t.tasks.status[status]}
                </p>
              </div>
              <span className="rounded-full bg-ink/5 px-1.5 py-0.5 text-[10px] font-semibold text-content-3">
                ...
                <div
                  className={cn(
                    ...
                    isOver
                      ...
                      : "border-ink/12 bg-surface/30 text-content-3",
                  )}
                >
...
function KanbanCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 text-xs text-content-3">
        ...
        <div className="flex shrink-0 items-center gap-1">
          {task.estimated_minutes != null && (
            <span className="rounded-md bg-ink/5 px-1.5 py-0.5 text-[10px] font-medium text-content-3">
      ...
      <select
        ...
        className="w-full rounded-md border border-ink/10 bg-cream/50 px-2 py-1 text-xs text-content-2 transition-colors focus:border-brand focus:bg-surface focus:outline-none focus:ring-2 focus:ring-brand/20"
      >
